...
public class WasteService {
    ...
    public WasteService(CategoryRepository categoryRepository, WasteRepository wasteRepository) {
    ...
    private WasteDTO convertToDto(Waste waste){
        ...
        wasteDTO.setName(waste.getName());
        wasteDTO.setCategory(waste.getCategory().getName());
    ...
    public WasteDTO updateById(Long id, WasteDTO wasteDTO) {
        ...
        Category category = categoryRepository.findByName(wasteDTO.getCategory())
